      ...
      <div className="flex-none flex flex-col md:flex-row justify-between items-start md:items-end gap-3 mb-3">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          ...
          <button className={headerBtnStyle}>
            <span className="hidden sm:inline">Start</span><span className="text-gray-300">→</span><span className="hidden sm:inline">End</span> <Calendar className="w-3.5 h-3.5 text-gray-400" />
          </button>
